(() => {
  ...
  let savedTokens = [];
  let settings = { compact: false, autoFetch: true, syncAvatars: true, encrypt: true, autoBackup: false, autoswitch: true, syncCookies: true, restoreStorage: false, verify: true };
